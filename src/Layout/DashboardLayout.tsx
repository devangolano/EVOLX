  ...
  const menuItems = [
    ...
    { 
      ...
      submenu: [
        ...
        { title: 'Cadastro de Pessoas', path: '/dashboard/pessoas' },
        ...
        { title: 'Classificação Pessoa', path: '/dashboard/person-classification' },
        { title: 'Grau Parentesco', path: '/dashboard/kinship-degree' },
        { title: 'Grupo de Curso', path: '/dashboard/course-group' },
        { title: 'Grupo Motivo Visita', path: '/dashboard/visit-reason-group' },
        { title: 'Motivo Visita', path: '/dashboard/visit-reason' },
        { title: 'Necessidade Especial', path: '/dashboard/special-needs' },
        { title: 'Setor', path: '/dashboard/sector' },
        { title: 'Situação Imóvel', path: '/dashboard/property-situation' },
        { title: 'Situação Prop. Rural', path: '/dashboard/rural-property-situation' },
        { title: 'Tipo Acesso Prop.', path: '/dashboard/property-access-type' },
        { title: 'Tipo Documento', path: '/dashboard/document-type' },
        { title: 'Tipo Responsável', path: '/dashboard/responsible-type' }
      ]
    },
    { 
      title: 'Escolar', 
